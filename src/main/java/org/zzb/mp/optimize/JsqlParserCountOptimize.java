...
public class JsqlParserCountOptimize implements ISqlParser {
    ...
    private final Log logger = LogFactory.getLog(com.baomidou.mybatisplus.extension.plugins.pagination.optimize.JsqlParserCountOptimize.class);
